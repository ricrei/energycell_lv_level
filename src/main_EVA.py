...
'''
#scenarios = ['A111410', 'B111410','C111410', 'A111510', 'B111510','C111510', 'A111610', 'B111610','C111610', 'A111710', 'B111710','C111710']
scenarios = ['A131410', 'B131410','C131410', 'A131510', 'B131510','C131510', 'A131610', 'B131610','C131610', 'A131710', 'B131710','C131710']
eva = load_scenario_data(scenarios)
evaluation.plot_heatmap_curtailed_power(eva, net_name, columns_scenarios = ['A131410', 'B131410','C131410'], x_ticklabels = ['2022_gre', '2037_gre', '2045_gre'], save_fig_dir=save_fig_dir+'4')
evaluation.plot_heatmap_curtailed_power(eva, net_name, columns_scenarios = ['A131510', 'B131510','C131510'], x_ticklabels = ['2022_bal', '2037_bal', '2045_bal'], save_fig_dir=save_fig_dir+'5')
evaluation.plot_heatmap_curtailed_power(eva, net_name, columns_scenarios = ['A131610', 'B131610','C131610'], x_ticklabels = ['2022_mar', '2037_mar', '2045_mar'], save_fig_dir=save_fig_dir+'6')
...
evaluation.plot_heatmap_curtailed_power(eva, net_name, columns_scenarios = ['A131410', 'A131510', 'A131610', 'A131710'], x_ticklabels = ['2022_gre', '2022_bal', '2022_mar', '2022_sch'], save_fig_dir=save_fig_dir+'A')
evaluation.plot_heatmap_curtailed_power(eva, net_name, columns_scenarios = ['B131410', 'B131510', 'B131610', 'B131710'], x_ticklabels = ['2037_gre', '2037_bal', '2037_mar', '2037_sch'], save_fig_dir=save_fig_dir+'B')
evaluation.plot_heatmap_curtailed_power(eva, net_name, columns_scenarios = ['C131410', 'C131510', 'C131610', 'C131710'], x_ticklabels = ['2045_gre', '2045_bal', '2045_mar', '2045_sch'], save_fig_dir=save_fig_dir+'C')
'''
...
evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios = ['A131410', 'B131410','C131410'], x_ticklabels = ['2022_gre', '2037_gre', '2045_gre'], n=n, save_fig_dir=save_fig_dir+'4')
evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios = ['A131510', 'B131510','C131510'], x_ticklabels = ['2022_bal', '2037_bal', '2045_bal'], n=n, save_fig_dir=save_fig_dir+'5')
evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios = ['A131610', 'B131610','C131610'], x_ticklabels = ['2022_mar', '2037_mar', '2045_mar'], n=n, save_fig_dir=save_fig_dir+'6')
...
evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios = ['A131410', 'A131510', 'A131610', 'A131710'], x_ticklabels = ['2022_gre', '2022_bal', '2022_mar', '2022_sch'], n=n, save_fig_dir=save_fig_dir+'A')
evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios = ['B131410', 'B131510', 'B131610', 'B131710'], x_ticklabels = ['2037_gre', '2037_bal', '2037_mar', '2037_sch'], n=n, save_fig_dir=save_fig_dir+'B')
evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios = ['C131410', 'C131510', 'C131610', 'C131710'], x_ticklabels = ['2045_gre', '2045_bal', '2045_mar', '2045_sch'], n=n, save_fig_dir=save_fig_dir+'C')
'''
