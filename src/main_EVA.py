...
#evaluation.plot_residualload_grid_issues_subplot_overall_eva(eva1=eva['sC106010n8spring'], eva2=eva['sC109010n8spring'], save_fig_dir=save_fig_dir+ 'res_grid_sfh100.png')
#evaluation.plot_residualload_grid_issues_subplot_overall_eva(eva1=eva['sC106010n8winter'], eva2=eva['sC109010n8winter'], save_fig_dir=save_fig_dir+ 'res_grid_sfh100.png')
...
evaluation.plot_heatmap_self_consumption_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_con_all_seasons_tes_to_pv.png')
evaluation.plot_heatmap_self_sufficiency_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_suff_all_seasons_tes_to_pv.png')
evaluation.plot_heatmap_curtailed_load_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +   'heatmap_curtailed_load_all_seasons_tes_to_pv.png')
evaluation.plot_heatmap_curtailed_pv_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +     'heatmap_curtailed_pv_all_seasons_tes_to_pv.png')
evaluation.plot_heatmap_mean_trafo_load_tes_to_pv(eva, scenario, net_name, save_fig_dir= save_fig_dir + 'heatmap_trafo_load_all_seasons_tes_to_pv.png')
evaluation.plot_heatmap_max_line_load_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_max_line_load_all_season_tes_to_pv.png')
evaluation.plot_heatmap_min_voltage_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_min_voltage_all_season_tes_to_pv.png')
evaluation.plot_heatmap_max_voltage_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_max_voltage_all_season_tes_to_pv.png')

eva = load_scenario_data(scenario, seasons=['spring', 'autumn', 'winter'])
evaluation.plot_heatmap_self_consumption_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_con_heat_period_tes_to_pv.png')
evaluation.plot_heatmap_self_sufficiency_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_suff_heat_period_tes_to_pv.png')
evaluation.plot_heatmap_curtailed_load_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +   'heatmap_curtailed_load_heat_period_tes_to_pv.png')
evaluation.plot_heatmap_curtailed_pv_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +     'heatmap_curtailed_pv_heat_period_tes_to_pv.png')
evaluation.plot_heatmap_mean_trafo_load_tes_to_pv(eva, scenario, net_name, save_fig_dir= save_fig_dir + 'heatmap_trafo_load_heat_period_tes_to_pv.png')

eva = load_scenario_data(scenario, seasons=['winter'])
evaluation.plot_heatmap_self_consumption_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_con_winter_tes_to_pv.png')
evaluation.plot_heatmap_self_sufficiency_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_suff_winter_tes_to_pv.png')
evaluation.plot_heatmap_curtailed_load_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +   'heatmap_curtailed_load_winter_tes_to_pv.png')
evaluation.plot_heatmap_curtailed_pv_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +     'heatmap_curtailed_pv_winter_tes_to_pv.png')
evaluation.plot_heatmap_mean_trafo_load_tes_to_pv(eva, scenario, net_name, save_fig_dir= save_fig_dir + 'heatmap_trafo_winter_tes_to_pv.png')

#eva = load_scenario_data(scenario, seasons=['summer'])
#evaluation.plot_heatmap_self_consumption_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_con_summer_tes_to_pv.png')
#evaluation.plot_heatmap_self_sufficiency_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_suff_summer_tes_to_pv.png')
#evaluation.plot_heatmap_curtailed_load_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +   'heatmap_curtailed_load_summer_tes_to_pv.png')
#evaluation.plot_heatmap_curtailed_pv_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +     'heatmap_curtailed_pv_summer_tes_to_pv.png')
#evaluation.plot_heatmap_mean_trafo_load_tes_to_pv(eva, scenario, net_name, save_fig_dir= save_fig_dir + 'heatmap_trafo_summer_tes_to_pv.png')

#eva = load_scenario_data(scenario, seasons=['spring'])
#evaluation.plot_heatmap_self_consumption_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_con_spring_tes_to_pv.png')
#evaluation.plot_heatmap_self_sufficiency_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir + 'heatmap_self_suff_spring_tes_to_pv.png')
#evaluation.plot_heatmap_curtailed_load_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +   'heatmap_curtailed_load_spring_tes_to_pv.png')
#evaluation.plot_heatmap_curtailed_pv_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir +     'heatmap_curtailed_pv_spring_tes_to_pv.png')
#evaluation.plot_heatmap_mean_trafo_load_tes_to_pv(eva, scenario, net_name, save_fig_dir= save_fig_dir + 'heatmap_trafo_load_spring_tes_to_pv.png')
