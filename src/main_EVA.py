...
#scenarios = ['4101110', '7105210', '7102210', '7103310']
scenarios = ['4101110', '6111110', '6121110', '6131110', '6141110', '6151110']
#scenarios = ['4101110', '4101111', '6131110', '7103310', '8133310']
#scenarios = ['4101110', '6131110', '7103310', '8133310']
#scenarios = ['4101110', '8115210', '8122210', '8133310']
eva = load_scenario_data(scenarios)
...
evaluation.plot_heatmap_componentloading_mean_peak(eva, net_name, columns_scenarios = ['4101110', '6111110', '6121110', '6131110', '6141110', '6151110'], x_ticklabels = ['4', '5d-H', '5p-H', '5pk-H', '5pk-C-T', '5pk-C-S'], save_fig_dir=save_fig_dir+'6')
#evaluation.plot_heatmap_componentloading_mean_peak(eva, net_name, columns_scenarios = ['4101110', '7105210', '7102210', '7103310'], x_ticklabels = ['4', '6d', '6p', '6pk'], save_fig_dir=save_fig_dir+'7')
#evaluation.plot_heatmap_componentloading_mean_peak(eva, net_name, columns_scenarios = ['4101110', '8115210', '8122210', '8133310'], x_ticklabels = ['4', '7d', '7p', '7pk'], save_fig_dir=save_fig_dir+'8')
#evaluation.plot_heatmap_componentloading_mean_peak(eva, net_name, columns_scenarios = ['4101110', '6131110', '7103310', '8133310'], x_ticklabels = ['4', '5pk-H', '6pk', '7pk'], save_fig_dir=save_fig_dir+'0567')
#evaluation.plot_heatmap_componentloading_mean_peak(eva, net_name, columns_scenarios = ['4101110', '4101111', '6131110', '7103310', '8133310'], x_ticklabels = ['1', '2', '3', '4', '5'], save_fig_dir=save_fig_dir+'1_')
'''
...
#evaluation.plot_heatmap_curtailed_power(eva, net_name, columns_scenarios = ['4101110', '6111110', '6121110', '6131110', '6141110', '6151110'], x_ticklabels = ['4', '5d-H', '5p-H', '5pk-H', '5pk-C-T', '5pk-C-S'], save_fig_dir=save_fig_dir+'6')
...
evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios=['4101110', '6111110', '6121110', '6131110', '6141110', '6151110'], x_ticklabels = ['4', '5d-H', '5p-H', '5pk-H', '5pk-C-T', '5pk-C-S'], n=n, save_fig_dir=save_fig_dir+'1')
...
#evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios=['4101110', '6111110', '6121110', '6131110', '6141110', '6151110'], x_ticklabels = ['4', '5d-H', '5p-H', '5pk-H', '5pk-C-T', '5pk-C-S'], n=n, save_fig_dir=save_fig_dir+'6')
#evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios=['4101110', '7105210', '7102210', '7103310'], x_ticklabels = ['4', '6d', '6p', '6pk'], n=n, save_fig_dir=save_fig_dir+'7')
#evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios=['4101110', '8115210', '8122210', '8133310'], x_ticklabels = ['4', '7d', '7p', '7pk'], n=n, save_fig_dir=save_fig_dir+'8')
#evaluation.plot_heatmap_self_sufficiency(eva, net_name, columns_scenarios=['4101110', '6131110', '7103310', '8133310'], x_ticklabels = ['4', '5pk-H', '6pk', '7pk'], n=n, save_fig_dir=save_fig_dir+'0567')
#'''
