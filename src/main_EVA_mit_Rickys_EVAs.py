...
scenarios = ['C106010', 'C107010', 'C108010']
...
scenario = ['A006010', 'A306010', 'A106010', 'A007010', 'A307010', 'A107010', 'A008010', 'A308010', 'A108010', \
...
evaluation.plot_heatmap_self_sufficiency_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir)
#evaluation.plot_heatmap_curtailed_load_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir)
#evaluation.plot_heatmap_mean_trafo_load_tes_to_pv(eva, scenario, net_name, save_fig_dir=save_fig_dir)
...
evaluation.plot_heatmap_componentloading_mean_peak(eva, net_name, columns_scenarios = ['A106110', 'A107110', 'A108110', 'B106110', 'B107110', 'B108110', 'C106110', 'C107110', 'C108110'], x_ticklabels = ['6', '7', '8'], save_fig_dir=save_fig_dir+'1_')
'''
