...
class EnergyCell():
    ...
    def initiate_evaluation(self):
        self.eva = EvaluationSingleCase(self.grid, self.output_dir, self.net_name, self.scenario[0], self.time_scope, self.save_full_data, self.grid_analysis)
    ...
    def scenario_interpreter(self, scenario):
      ...
      phd_scenarios = [
        ...
        [7,1,0,5,2,0,0], [7,1,0,5,2,1,0], [7,1,0,5,2,0,1],
        [7,1,0,2,2,0,0], [7,1,0,2,2,1,0], [7,1,0,2,2,0,1],
        [7,1,0,3,3,0,0], [7,1,0,3,3,1,0], [7,1,0,3,3,0,1],
        [8,1,3,3,3,0,0], [8,1,3,3,3,1,0], [8,1,3,3,3,0,1], [8,1,3,3,3,1,1], [8,1,5,3,3,1,0], [8,1,1,5,2,1,0], [8,1,2,2,2,1,0],

        [9,1,3,3,3,0,0], [9,1,3,3,3,1,0], [9,1,3,3,3,0,1], [9,1,3,3,3,1,1], [9,1,5,3,3,1,0],
                      ]
